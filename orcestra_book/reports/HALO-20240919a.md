...
- 13:47 UTC SECOND METEOR OVERPASS and typical scenes with mirror-like ocean surface and some scattered shallow cumuli  (see photo below). Meteor report very low wind speeds circa 0.5m/s.
...
An example of the mirror like ocean surface and less regular shallow cumuli cloud streets at 19:16 UTC. (The rainbow in the bottom corner is an artifact.)
```
