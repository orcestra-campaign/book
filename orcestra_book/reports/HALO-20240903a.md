...
instruments:
  ...
  Smart:
    ...
    operational: true
  SpecMACS:
    comment: Fully functional except for some icing on both side looking cameras.
    operational: true
  VELOX:
    comment: no entry
    operational: true
  WALES:
    comment: no entry
    operational: true
categories: [ec_under, ec_track, c_north, c_mid, c_south, meteor]
orphan: true
---
...
```{card}
:img-top: ../figures/HALO-20240903a/HALO_20240903a_BACARDI_QL.png
BACARDI: Time series.
```
...
```{card}
:img-top: ../figures/HALO-20240903a/HALO_20240903a_KT19_QL.png
KT19 Timeseries of brigthness temperature.
```

```{card}
:img-top: ../figures/HALO-20240903a/HALO_20240903a_SMART_QL.png
...
```{card}
:img-top: ../figures/HALO-20240903a/HALO-20240903-wales-ec.png
