...
instruments:
  ...
  HAMP:
    ...
    operational: true
  Dropsondes:
    comment: Had to omit a drop on second circle due to aircraft conflict, five sondes with no launc
    operational: true
  Smart/VELOX:
    comment: problems with motion compensation for SMART, hence stabelized with respect to fuselage
    operational: true
  SpecMACS:
