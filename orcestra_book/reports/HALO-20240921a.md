...
## Conditions
%include flightpath animation
%Flight path superimposed on the "visible" image from NOAA's Geostationary Operational Environmental Satellites (GOES) 16 satellite on 21th September 2024. The green dots mark the live location of sucessfully launched dropsondes. Credit: Lukas Kluft.
...
```{card}
:img-top: ../figures/HALO-20240921a/BACARDI_QL_20240921a.png
BACARDI
```
