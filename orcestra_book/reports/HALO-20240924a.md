...
```{card}
%:img-top: ../figures/HALO-20240919a/HALO_20240924a_BACARDI_QL.png
BACARDI
```

```{card}
:img-top: ../figures/HALO-20240919a/HALO_20240924a_KT19_QL.png
KT19 Timeseries of brigthness temperature.
```

```{card}
:img-top: ../figures/HALO-20240919a/HALO_20240924a_SMART_QL.png
SMART Time series of upward and downward spectral irradiadiance, and albedo.
```

```{card}
%:img-top: ../figures/HALO-20240919a/QL_VELOX_HALO_20240925a.jpg
