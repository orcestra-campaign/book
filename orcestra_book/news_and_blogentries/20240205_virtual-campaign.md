...
We not only had insights into objectives of individual [sub campaigns](https://orcestra-campaign.org/orcestra.html), likewise, did we learn about tools like [AERIS](https://observations.ipsl.fr/aeris/maestro/#/map), [TOOCAN](https://toocan.ipsl.fr), [MISVA](https://misva.aeris-data.fr), GOES and [pyorcestra](https://github.com/orcestra-campaign/pyorcestra) which will support us while preparing and operating the campaign.
