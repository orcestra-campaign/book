...
ec_track = orcestra.sat.SattrackLoader("EARTHCARE", "2024-09-01", kind="PRE", roi="BARBADOS").get_track_for_day(f"{flight_time:%Y-%m-%d}")
...
circle_legs = [
     IntoCircle(c_east.assign(fl=430), radius, 360, enter = 90),
