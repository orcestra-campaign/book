...
orphan: true
platform: HALO
takeoff: '2024-09-16 10:20:00Z'
landing: '2024-09-16 19:49:00Z'
---
...
aircraft = "HALO"
flight_time = datetime(2024, 9, 19, 10, 20, 0)
...
sat_fcst_date = "2024-09-16" # date to get satelite forecast(s) from
...
ifs_fcst_time = "2024-09-16" # date to get IFS forecast(s) from
...
dist1 = geod_dist(airport, pace_start) + 5.0 * radius
circ_1 = airport.course(geod_azi(airport, meteor), dist1).assign(label="c1")
