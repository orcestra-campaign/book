...
c_north  = point_on_track(ec_track,lat= 20.00).assign(label = "c_north")
c_south  = point_on_track(ec_track,lat= 12.50).assign(label = "c_south")
c_mid    = point_on_track(ec_track,lat= 0.5*(c_north.lat+c_south.lat)).assign(label = "c_mid")

ec_north = point_on_track(ec_track,lat= 20.50).assign(label = "ec_north") 
