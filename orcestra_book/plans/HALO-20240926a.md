...
aircraft = "HALO"
flight_time = datetime(2024, 9, 26, 12, 51)
...
sat_fcst_date = "2024-09-22"  # date to get satelite forecast(s) from
ifs_fcst_time = "2024-09-22"  # date to get IFS forecast(s) from
...
mid_mid = mid_south.towards(mid_north, 0.4).assign(label="c_mid", fl=400)

lat_east = 11.5
lon_east = mid_mid.lon + 2.6 + ((5 * 60 * speed_halo) / 110e3)
mid_east = LatLon(lat_east, lon_east, fl=430, label="c_east")

lat_west = 15
lon_west = -58.7
mid_west = LatLon(lat_west, lon_west, fl=450, label="c_west")
...
waypoints = [
    ...
    ec_south,
    IntoCircle(mid_south, radius=radius, angle=-360),
    ec_south,
    ec_under,
    ec_north,
    IntoCircle(mid_north, radius=radius, angle=360),
    IntoCircle(mid_west, radius=radius, enter=-90, angle=360),
    tbpb,
]
