...
c_atr    = LatLon(17.5,-24.00, label = "c_atr")
...
extra_waypoints = [
    ...
    point_on_track(ec_track,lat=  7.75).assign(label="x_sonde", note="Southern alternative center for c_mid"),
    ]
...
waypoints = [
     ...
     mindelo.assign(fl=350),
     IntoCircle(c_atr.assign(fl=350), atr_radius, -360, enter=180.), 
     airport.assign(fl=0),
     ]
