...
c_new = LatLon(15.580,-22.1, label = "c_atr")
...
ec_north = point_on_track(ec_track,lat= 15.58).assign(label = "ec_north") 
...
c_atr    = LatLon(15.580,-22.1, label = "c_atr")
junction = c_atr.towards(ec_north,distance=atr_radius*1.2).assign(label = "junction")
...
extra_waypoints = [
    point_on_track(ec_track,lat= 13.67).assign(label="x_cnn", note="Northern alternative center for c_north"),
    point_on_track(ec_track,lat= 11.50).assign(label="x_cns", note="Southern alternative center for c_north"),
    point_on_track(ec_track,lat=  7.75).assign(label="x_cms", note="Southern alternative center for c_mid"),
    c_south.towards(c_mid).assign(label="x_sonde", note="Southern alternative center for c_mid"),
    LatLon(17.5,-24.00).assign(label="x_atr", note="alternative for ATR")
    ]
...
waypoints = [
     ...
     junction.assign(fl=350),
     IntoCircle(c_atr.assign(fl=350), atr_radius, -360, enter=-75.), 
     airport.assign(fl=0),
     ]
