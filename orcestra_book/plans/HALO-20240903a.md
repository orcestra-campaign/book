...
j_end    = LatLon(lat=ec_north.lat,lon=sal.lon).assign(label = "junction")
...
x_xsd = c_south.towards(c_mid).assign(label="x_sonde", note="Southern alternative center for c_mid")

extra_waypoints = [x_cnn,x_cms,LatLon(17.5,-24.00).assign(label="x_atr", note="alternative for ATR")]
...
waypoints = [
     ...
     IntoCircle(c_atr.assign(fl=350), atr_radius,-360, enter=150.), 
     airport.assign(fl=0),
     ]
