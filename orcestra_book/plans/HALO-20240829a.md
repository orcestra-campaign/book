...
takeoff_time = np.datetime64("2025-08-29T10:21:30")
...
localdir = "/Users/karsten/DKRZ/TRIPS/ORCESTRA/WB/FLIGHTPLANS"
if os.path.isdir(localdir):
    flight_kml = f"/Users/karsten/DKRZ/TRIPS/ORCESTRA/WB/FLIGHTPLANS/{flight_index}.kml"
    print (f"writing path to {flight_kml}")
    with open(flight_kml, "w") as f:
        f.write(to_kml(path))
        
    flight_txt = f"//Users/karsten/DKRZ/TRIPS/ORCESTRA/WB/FLIGHTPLANS/{flight_index}_waypoints.txt"
