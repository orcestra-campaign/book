...
crew = {
    ...
    'HAMP': 'Jakob Deutloff (Janina B\xF6hmeke)',
    'SMART/VELOX': 'tba',
...
west = meteor.towards(ec_circ, fraction=2.0).assign(label="west", note = "circle two times") #LatLon(lat = 7.50, lon = -48.00).assign(label = "west")
